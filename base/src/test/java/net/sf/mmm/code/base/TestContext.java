    ...
    private static class TestSoureLoader extends BaseSourceLoaderImpl {
        ...
        public BaseGenericType getType(Class<?> clazz) {
            ...
            if (pkg != null) {
                ...
                BiFunction<BasePackage, String, BasePackage> factory =
                    (parentPkg, simpleName) -> createPackage(pkg, parentPkg, simpleName);
                parentPackage =
                    getPackage(parentPackage.getChildren(), source.parseName(pkgName), false, factory, true, true);
            }
