...
public class BasePackageTest extends BaseContextTest {
  ...
  /**
   * Test of
   * {@link BasePathElements#getPackage(io.github.mmm.code.api.CodeName, boolean, java.util.function.BiFunction, boolean)}
  ...
  public void testGetPackageAddFailImmutable() {
    ...
    try {
      ...
      assertThat(e.getNlsMessage().getMessage())
          .isEqualTo("Failed to modify read-only object: BasePathElements:«root».getChildren()");
    }
  }
