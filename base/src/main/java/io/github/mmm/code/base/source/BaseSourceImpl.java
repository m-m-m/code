...
import io.github.mmm.code.base.AbstractBaseProvider;
...
/**
 * Implementation of {@link io.github.mmm.code.api.source.CodeSource} for Java.
 *
...
public class BaseSourceImpl extends AbstractBaseProvider implements BaseSource {
  ...
  public BaseSourceDependencies getDependencies() {
    ...
    if (this.dependencies == null) {
      ...
      if (this.dependencies == null) {
        throw new ObjectNotFoundException("dependencies");
      }
    }
