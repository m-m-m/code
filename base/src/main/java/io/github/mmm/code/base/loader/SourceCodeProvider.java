...
public interface SourceCodeProvider extends AutoCloseable {
  ...
  /**
   * @param qualifiedName the qualified name of the {@link io.github.mmm.code.api.type.CodeType} to open.
  ...
  /**
   * @param qualifiedName the qualified name of the {@link io.github.mmm.code.api.CodePackage} to open.
  ...
  /**
   * @param qualifiedName the qualified name of the {@link io.github.mmm.code.api.CodePackage} to scan.
   * @return a {@link List} with the {@link io.github.mmm.code.api.type.CodeType#getSimpleName() simple names} of the
   *         {@link io.github.mmm.code.api.type.CodeType}s in the specified package or {@code null} if scan is not
   *         supported.
   * @throws IOException on I/O error.
   */
