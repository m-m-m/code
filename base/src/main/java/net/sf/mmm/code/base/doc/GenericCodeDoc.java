 ...
 * @since 1.0.0
 */
public abstract class GenericCodeDoc extends AbstractCodeNodeItem implements CodeDoc {

  private static final Logger LOG = LoggerFactory.getLogger(GenericCodeDoc.class);
   ...
   *
   * @param template the {@link GenericCodeDoc} to copy.
   */
  public GenericCodeDoc(GenericCodeDoc template) {
   ...
   */
  protected abstract Pattern getInlineTagPattern();
