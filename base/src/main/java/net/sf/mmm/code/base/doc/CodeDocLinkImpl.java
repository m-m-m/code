 ...
 * @since 1.0.0
 */
public class CodeDocLinkImpl implements CodeDocLink {
   ...
   */
  public CodeDocLinkImpl(String value, char separator, String owningType, Function<CodeDocLink, String> urlProvider,
      Function<CodeDocLink, Object> valueProvider) {
  ...
  /**
   * @return the optional {@link CodeDocMethodLinkImpl} if the {@link #getAnchor() anchor} is a method
  ...
  public CodeDocMethodLink getMethodLink() {
    ...
    if (!this.methodLinkSet) {
      this.methodLink = CodeDocMethodLinkImpl.of(this.anchor);
