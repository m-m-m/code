...
public class BaseDocParser {
    ...
    /**
     * @param operation
     *            the {@link CodeOperation} that has already been created with its entire signature.
     * @param javaDocLines
     *            the {@link List} of plain {@link CodeDoc} {@link CodeDoc#getLines() lines} to parse and
     *            apply to the given {@link CodeOperation}.
     */
    ...
    /**
     * @param type
     *            the {@link CodeType} that has already been created with type variables.
     * @param javaDocLines
     *            the {@link List} of plain {@link CodeDoc} {@link CodeDoc#getLines() lines} to parse and
     *            apply to the given {@link CodeType}.
     */
     ...
     * @param javaDocLines
     *            the {@link List} of plain {@link CodeDoc} {@link CodeDoc#getLines() lines} to parse and
     *            apply to the given {@link CodeField}.
     */
