...
/**
 * Generic implementation of {@link CodeLocalVariable}.
 *
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 */
public class GenericVariableLocal extends GenericAtomicStatement implements CodeLocalVariable {
   ...
   */
  public GenericVariableLocal(String name, CodeGenericType type, CodeExpression expression, boolean finalFlag) {
  ...
  protected void doWrite(Appendable sink, String newline, String defaultIndent, String currentIndent, CodeSyntax syntax) throws IOException {
    ...
    sink.append(syntax.getKeyword(this));
