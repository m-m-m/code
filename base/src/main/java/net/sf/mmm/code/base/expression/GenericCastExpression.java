 ...
 * @since 1.0.0
 */
public class GenericCastExpression extends GenericExpression implements CodeCastExpression {
   ...
   */
  public GenericCastExpression(CodeGenericType type, CodeExpression expression) {
