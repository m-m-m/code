...
/**
 * Implementation of {@link AbstractCodeSourceDescriptor} as immutable type.
 *
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 */
public class CodeSourceDescriptorType extends AbstractCodeSourceDescriptor {
   ...
   */
  public CodeSourceDescriptorType(String id) {
   ...
   */
  public CodeSourceDescriptorType(String groupId, String artifactId, String version, String docUrl) {
   ...
   */
  public CodeSourceDescriptorType(CodeSourceDescriptor template) {
