...
/**
 * Generic implementation of {@link CodeBlockComment}.
 *
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 */
public class GenericBlockComment extends GenericComment implements CodeBlockComment {
   ...
   */
  public GenericBlockComment(CodeComment comment) {
   ...
   */
  public GenericBlockComment(List<String> commentLines) {
   ...
   * @param commentLines the {@link #getCommentLines() comment lines}.
   */
  public GenericBlockComment(String... commentLines) {
