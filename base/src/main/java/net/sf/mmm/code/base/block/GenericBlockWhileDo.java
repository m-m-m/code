 ...
 * @since 1.0.0
 */
public class GenericBlockWhileDo extends GenericBlockStatementWithCondition
    implements CodeBlockWhileDo, CodeNodeItemWithGenericParent<CodeBlock, GenericBlockWhileDo> {
   ...
   */
  public GenericBlockWhileDo(CodeBlock parent, CodeCondition condition, CodeStatement... statements) {
   ...
   * @param statements the {@link #getStatements() statements}.
   */
  public GenericBlockWhileDo(CodeBlock parent, CodeCondition condition, List<CodeStatement> statements) {
   ...
   */
  public GenericBlockWhileDo(GenericBlockStatementWithCondition template, CodeBlock parent) {

    super(template, parent);
  }

  @Override
  public GenericBlockWhileDo copy() {

    return copy(getParent());
  }

  @Override
  public GenericBlockWhileDo copy(CodeBlock newParent) {

    return new GenericBlockWhileDo(this, newParent);
  }
