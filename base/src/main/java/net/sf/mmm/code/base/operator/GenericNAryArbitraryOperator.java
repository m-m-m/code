...
/**
 * Generic implementation of {@link CodeNAryArbitraryOperator}.
 *
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 */
public final class GenericNAryArbitraryOperator extends GenericNAryOperator implements CodeNAryArbitraryOperator {

  /** Instance for {@link #NAME_ADD}. */
  public static final GenericNAryArbitraryOperator ADD = new GenericNAryArbitraryOperator(NAME_ADD);
   ...
   */
  public GenericNAryArbitraryOperator(String name) {
