...
/**
 * Generic implementation of {@link CodeMethodInvocation}.
 *
 * @author Joerg Hohwiller (hohwille at users.sourceforge.net)
 * @since 1.0.0
 */
public class GenericMethodInvocation extends GenericMemberReference implements CodeMethodInvocation {
   ...
   */
  public GenericMethodInvocation(CodeMethod method, List<? extends CodeExpression> arguments) {
   ...
   */
  public GenericMethodInvocation(CodeMethod method, List<? extends CodeExpression> arguments, CodeGenericType type) {
   ...
   */
  public GenericMethodInvocation(CodeMethod method, List<? extends CodeExpression> arguments, CodeExpression expression) {
   ...
   * @param typeParameters the optional {@link #getTypeParameters() type parameters}.
   */
  protected GenericMethodInvocation(CodeMethod method, List<? extends CodeExpression> arguments, CodeExpression expression, CodeGenericType type,
      List<? extends CodeGenericType> typeParameters) {
