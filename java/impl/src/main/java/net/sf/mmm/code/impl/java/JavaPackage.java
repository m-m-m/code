...
public final class JavaPackage extends JavaPathElement
   ...
   *        {@code null}.
   */
  public JavaPackage(JavaSource source, JavaPackage superLayerPackage) {
   ...
   *        {@code null}.
   */
  public JavaPackage(JavaPackage parentPackage, String simpleName, Package reflectiveObject, JavaPackage superLayerPackage) {
