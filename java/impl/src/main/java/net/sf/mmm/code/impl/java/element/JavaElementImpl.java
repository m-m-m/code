 ...
 * @since 1.0.0
 */
public abstract class JavaElementImpl extends JavaNodeItemImpl implements JavaElement {
   ...
   *
   * @param template the {@link JavaElementImpl} to copy.
   */
  public JavaElementImpl(JavaElementImpl template) {
  ...
  protected void doWriteAnnotations(Appendable sink, String newline, String defaultIndent, String currentIndent, CodeSyntax syntax) {
    ...
    JavaAnnotations myAnnotations = getAnnotations();
