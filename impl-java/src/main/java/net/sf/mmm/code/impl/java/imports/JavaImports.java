 ...
 * @since 1.0.0
 */
public class JavaImports extends JavaNodeItemContainerFlat<CodeImport, JavaImport>
    implements CodeImports, CodeNodeItemWithGenericParent<JavaFile, JavaImports> {
