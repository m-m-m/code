...
public abstract interface CodeNodeItemContainerWithName<I extends CodeItem> extends CodeNodeItemContainer<I> {
   ...
   * @return the {@link CodeItem} from all items with the given {@code name} or {@code null} if no such item exists.
   */
  I get(String name);
  ...
  /**
   * @param name the {@link CodeItemWithName#getName() name} of the requested {@link CodeItem}.
   * @return the {@link CodeItem} from the {@link #getDeclared() declared items} with the given {@code name} or
