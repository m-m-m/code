 ...
 * @since 1.0.0
 */
public interface CodeType extends CodeGenericType, CodeElementWithModifiers, CodeMutableItemWithQualifiedName,
    CodeElementWithTypeVariables, CodeAdvancedMergeableItem<CodeType>, CodeNodeItemCopyable<CodeElement, CodeType> {
  ...
  /**
   * @return the {@link CodeFields} containing the actual {@link io.github.mmm.code.api.member.CodeField}s.
   */
  CodeFields getFields();

  /**
   * @return the {@link CodeMethods} containing the actual {@link io.github.mmm.code.api.member.CodeMethod}s.
   */
  CodeMethods getMethods();

  /**
   * @return the {@link CodeConstructors} containing the actual {@link io.github.mmm.code.api.member.CodeConstructor}s.
   */
