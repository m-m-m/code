...
public interface CodePathElements extends CodeNodeItemContainerFlat<CodePathElement>, CodeNodeItemCopyable<CodePackage, CodePathElements> {
   ...
   *        {@link io.github.mmm.code.api.source.CodeSource#getRootPackage() root package} with a
   *        {@link io.github.mmm.code.api.item.CodeItemWithQualifiedName#getQualifiedName() qualified name} parsed via
   *        {@link io.github.mmm.code.api.source.CodeSource#parseName(String)}.
