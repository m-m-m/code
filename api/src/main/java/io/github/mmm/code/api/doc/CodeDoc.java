...
public interface CodeDoc extends CodeSimpleMergeableItem<CodeDoc>, CodeNodeItemCopyable<CodeElement, CodeDoc> {
   ...
   * doc is accessed via the according {@link io.github.mmm.code.api.arg.CodeParameter}.
   */
   ...
   * via the according {@link io.github.mmm.code.api.arg.CodeException}.
   */
   ...
   * according doc is accessed via the according {@link io.github.mmm.code.api.arg.CodeReturn}.
   */
  ...
  /**
   * <b>Attention:</b> Child elements such as {@link io.github.mmm.code.api.arg.CodeParameter}s,
   * {@link io.github.mmm.code.api.arg.CodeException}s, {@link io.github.mmm.code.api.arg.CodeReturn}, and
   * {@link io.github.mmm.code.api.type.CodeTypeVariable}s hold their specific {@link CodeDoc} that is not included in
   * the {@link CodeDoc} of their parent {@link io.github.mmm.code.api.member.CodeOperation} or
   * {@link io.github.mmm.code.api.type.CodeType}. Therefore you shall not see or {@link #add(String...) add} any lines
