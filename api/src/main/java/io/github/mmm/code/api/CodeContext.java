...
public interface CodeContext extends CodeProvider {
  ...
  /**
   * @return the {@link CodeType#isVoid() void} {@link CodeType} for a default {@link io.github.mmm.code.api.arg.CodeReturn
   *         return}.
   */
  ...
  /**
   * @return the {@link CodeFactory} to create specific {@link io.github.mmm.code.api.item.CodeItem}s.
   */
   ...
   *         source} that is {@link io.github.mmm.code.api.source.CodeSource#isMutable() mutable} so you can add your own
