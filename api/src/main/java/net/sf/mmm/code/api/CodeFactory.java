...
public interface CodeFactory {
   ...
   * @param propertyName the {@link net.sf.mmm.code.api.member.CodeProperty#getName() property name}.
   * @param propertyType the {@link net.sf.mmm.code.api.member.CodeProperty#getType() property type}.
