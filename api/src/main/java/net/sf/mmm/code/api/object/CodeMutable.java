...
public abstract interface CodeMutable {
  ...
  /**
   * By default a {@link net.sf.mmm.code.api.node.CodeNode} retrieved from an existing source (e.g. via
   * {@link net.sf.mmm.code.api.CodeContext#getType(String)}) is immutable. Use an according {@code edit()} method to
   * get a new mutable copy of the object before you do any changes. A newly created
   * {@link net.sf.mmm.code.api.item.CodeItem} will however always be mutable. In case a {@link CodeMutable} object is
   * immutable, all setter methods will throw a {@link net.sf.mmm.util.exception.api.ReadOnlyException} and all
