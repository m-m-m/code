 ...
 * called recursively during the merge except for {@link net.sf.mmm.code.api.node.CodeNodeItemContainer}s.
 *
...
public interface CodeMergeStrategyDecider {
   ...
   *        for the {@link net.sf.mmm.code.api.node.CodeNodeItem#getParent() parent} in case of a recursive
